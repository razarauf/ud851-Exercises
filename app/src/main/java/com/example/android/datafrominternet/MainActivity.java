...
public class MainActivity extends AppCompatActivity {
    ...
    // Get an intentional error of android.os.NetworkOnMainThreadException
    // "NetworkOnMainThreadException" - networking which could take seconds
    // running on the main thread - need to run on a secondary execution thread -> Async tasks
